...
```{r}
# TODO tbl_wirtschaftswachstum(1975, 1983)
```

```{r}
# TODO tbl_wirtschaftswachstum(1983, 1991)
```

```{r}
# TODO tbl_wirtschaftswachstum(1991, 2000)
```
...
Für das zweidimensionale Histogramm definiert man Klassen für
