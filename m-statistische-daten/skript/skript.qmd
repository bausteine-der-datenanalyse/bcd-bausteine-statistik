...
#| fig-cap: Grundgesamtheit und Stichproben. Das Ergebnis hängt stark von der Auswahl der Stichprobe ab
...
plot_bars <- function(df, title) {
  ggplot(data = df) +
    ...
    labs(x = NULL, y = NULL, caption = title)
}
...
p1 + 
  plot_spacer() + 
  (
    plot_spacer() / p21 / p22 / p23 / plot_spacer() +
