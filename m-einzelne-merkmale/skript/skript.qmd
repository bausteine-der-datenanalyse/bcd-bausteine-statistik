...
#| fig-cap: "Drei Verteilungen jeweils in einem Kreis- und einem Säulendiagramm dargestellt. Die Kreisdiagramme unterscheiden sich auf den ersten Blick nur unwesentlich, die Eigenschaften der Verteilungen sind am Säulendiagramm besser ablesbar"
...
set.seed(432)
rnorm(15000) |> fig_histogram()
c(rnorm(3500), rnorm(1500, 4)) |> fig_histogram()
c(rnorm(3500), rnorm(1500, 4), rnorm(2500, 10)) |> fig_histogram()
```
...
rlnorm(10000) |> fig_histogram(q = 0.95)
rnorm(10000) |> fig_histogram()
rlnorm(10000) |> fig_histogram(q = 0.95) + scale_x_reverse()
```
...
```{r}
#| fig-alt: "Treppenfunktion der erreichten Prozentpunkte. Der Funktionswert $F(49)$ entspricht den 32% der Teilnehmenden, die nicht bestanden haben."
