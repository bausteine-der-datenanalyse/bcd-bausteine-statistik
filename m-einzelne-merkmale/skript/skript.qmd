...
#| fig-cap: |
#|  Gebräuchliche Diagrammtypen (Stab-, Säulen-, Balken-, Kreis- und Ringdiagramm)
...
#| fig-cap: |
#|  Zeitliche Entwicklung einer Verteilung in einem Säulendiagramm
...
#| fig-cap: |
#|  Drei Verteilungen jeweils in einem Kreis- und einem Säulendiagramm dargestellt.
...
#| fig-alt: |
#|  Gegenüberstellung einer linkssteilen, einer symmetrischen und einer rechtssteilen Verteilung
...
```{r}
#| fig-alt: |
#|  Treppenfunktion der erreichten Prozentpunkte. Der Funktionswert $F(49)$
