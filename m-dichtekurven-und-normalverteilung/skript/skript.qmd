...
#| label: fig-nq-plot
#| fig-cap: |
#|  Entstehung des Normal-Quantil-Plots: Die roten Punkte sind die empirisch erhobenen
...
#| fig-cap: |
#|  Verteilungen von Beobachtungen (oben) und zugehörige NQ-Plots (unten). Für das
...
#| fig-cap: |
#|  NQ-Plot zur Geschwindigkeitsmesung. Da die wirkliche Verteilung steilere Flanken
#|  besitzt als die angepasste Normalverteilung (@fig-normalverteilung-angepasst)
#|  ergibt sich der hierfür charakteristische Verlauf der Punkte: Kleine Werte
#|  liegen unterhalb der Geraden, große Werte oberhalb
